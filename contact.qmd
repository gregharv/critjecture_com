...
**Ready to build AI systems you can understand? Let's talk.**
:::
...
<form action="https://formspree.io/f/xnnzgoyk" method="POST">
...
::: {.form-group}
**Email**  
<input type="email" name="email" class="form-control" placeholder="you@yourcompany.com" required>
:::
...
- **Monday - Friday:** 4:00 PM - 7:00 PM EST
- **Saturday:** 9:00 AM - 5:00 PM EST
- **Sunday:** Closed
:::

::: {.calendar-embed}
[Schedule Free Consultation](https://calendly.com/gregsharvey/30min){.btn .btn-primary .btn-lg .center target="_blank"}
:::
:::
